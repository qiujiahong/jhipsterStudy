package com.nick.web.rest;

import com.nick.TasksApp;

import com.nick.domain.Task;
import com.nick.repository.TaskRepository;
import com.nick.service.TaskService;
import com.nick.web.rest.errors.ExceptionTranslator;
...
import static com.nick.web.rest.TestUtil.createFormattingConversionService;
...
public class TaskResourceIntTest {
    ...
    public void createTask() throws Exception {
        ...
        assertThat(testTask.getDuDate()).isEqualTo(DEFAULT_DU_DATE);
    ...
    @Test
    @Transactional
    public void checkDuDateIsRequired() throws Exception {
        int databaseSizeBeforeTest = taskRepository.findAll().size();
        // set the field null
        task.setDuDate(null);
    ...
    public void updateTask() throws Exception {
        ...
        assertThat(testTask.getDuDate()).isEqualTo(UPDATED_DU_DATE);
